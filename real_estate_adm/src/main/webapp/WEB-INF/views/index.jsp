	    ...
	    <div id="wrapper">
	                ...
	                <ul class="nav" id="main-menu">
	                    <li>
	                        <div class="user-img-div">
	                            <img src="resources/img/user.png" class="img-thumbnail" />
	                    ...
	                    <li>
	                        <a class="active-menu" href="index.html"><i class="fa fa-dashboard "></i>메인</a>
	                    </li>
	                    <li>
	        ...
	        <div id="page-wrapper">
	            <div id="page-inner">
	                <div class="row">
	                    <div class="col-md-12">
	                        <h1 class="page-head-line">메인</h1>
	                        <h1 class="page-subhead-line">간략 정보</h1>
	                ...
	                <div class="row">
	                    <div class="col-md-4">
	                        <div class="main-box mb-red" style="height:155px; color:white;">
	                    ...
	                    <div class="col-md-4">
	                        <div class="main-box mb-pink" style="height:155px;">
	                            <a href="#">
	                    ...
	                    <div class="col-md-8">
	                        <div class="list-group">
	                            <a href="#" class="list-group-item active">
	                                <h4 class="list-group-item-heading">최근 게시글</h4>
	                                        ...
	                                        <div class="media-body">
	                                            ...
	                                            <div class="media">
	                                                <a class="pull-left" href="#">
	                                                    <img class="media-object img-circle img-comments" src="resources/img/user.png" />
	                                                </a>
	                                                <div class="media-body">
	              ...
	              <!-- Nested media object -->
	                                                    <div class="media">
	                                                        <a class="pull-left" href="#">
	                                                            <img class="media-object img-circle img-comments" src="resources/img/user.gif" />
	                                                        </a>
	                                                        <div class="media-body">
